...
- **Server Syntax Crash**: The backend was crashing due to malformed edits in `server/server.js`. Reverted the broken changes and cleanly rewrote the seeding, transfer, and task routes.
