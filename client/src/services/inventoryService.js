...
const inventoryService = {
  ...
  deleteMaterialRequestDeep: (id) => inventoryApi.delete(`admin/material-requests/${id}`, { params: { mode: 'deep' } }),
  deleteMaterialRequest: (id) => inventoryApi.delete(`projects/material-request/${id}`),
  ...
  getPurchaseRequestQueue: () => inventoryApi.get('purchase/prq'),
